...
import { GIFT_WALLET_BZZ_AMOUNT, GIFT_WALLET_DAI_AMOUNT } from '../../src/gift-wallet-fees'
...
const GIFT_WALLET_FEES = { bzz: GIFT_WALLET_BZZ_AMOUNT, dai: GIFT_WALLET_DAI_AMOUNT }
